...
# -*- coding: utf-8 -*-
#
# bluesky_scanplans documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'scanplans.tex', 'bluesky_scanplans Documentation',
     'Contributors', 'manual'),
]
